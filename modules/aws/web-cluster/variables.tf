...
# Notice that none of the variables in this section have a "default" option
# Exclusion of the "default" argument means that the variable is required for the module
# ---------------------------------------------------------------------------------------------------------------------
